...
TargeAltitude = 10
NORTH_DURATION = 5 #Set duration for each segment.
SOUTH_DURATION = 5 #Set duration for each segment.
...
for x in range(6):
    ...
    send_ned_velocity(SOUTH,0,0,SOUTH_DURATION)
    send_ned_velocity(0,0,0,1)

    print("Velocity North")
    send_ned_velocity(NORTH,0,0,NORTH_DURATION)
    send_ned_velocity(0,0,0,1)

for x in range(6):
    print("Velocity East")
    send_ned_velocity(0,EAST,0,SOUTH_DURATION)
    send_ned_velocity(0,0,0,1)

    print("Velocity East")
    send_ned_velocity(0,WEST,0,SOUTH_DURATION)
    send_ned_velocity(0,0,0,1)
